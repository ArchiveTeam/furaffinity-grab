...
Follow the [instructions on the ArchiveTeam wiki](http://archiveteam.org/index.php?title=Warrior) for installing the Warrior, and select the "Fur Affinity" project in the Warrior interface.
...
### For Debian/Ubuntu:
    ...
    pip install seesaw
    su -c "cd /home/archiveteam; git clone https://github.com/ArchiveTeam/furaffinity-grab.git; cd furaffinity-grab; ./get-wget-lua.sh" archiveteam
...
6. `screen su -c "cd /home/archiveteam/furaffinity-grab/; run-pipeline pipeline.py --concurrent 2 --address '127.0.0.1' YOURNICKHERE" archiveteam`
