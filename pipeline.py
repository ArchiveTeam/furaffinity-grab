...
LUA_SHA1 = get_hash(os.path.join(CWD, 'furaffinity.lua'))
...
project = Project(
    ...
    project_html="""
        ...
        <h2>www.furaffinity.net <span class="links"><a href="http://www.furaffinity.net/">Website</a> &middot; <a href="http://tracker.archiveteam.org/furaffinity/">Leaderboard</a></span></h2>
        <p>Grabbing all images and other stuff from Fur Affinity.</p>
    """
)
